 ...
 const CountryImage = props => {
    ...
    const handlehange=(e)=>{
        ...
        reader.onload = (e) =>{
            ...
            setDataFile(file)
            props.imagePropsCountry(file)
            props.imageProps(true)
        } 
    }
    const containerStyle = {
        background: `url(http://161.35.199.172${props.countryDefault}) center center no-repeat`,
        ...
        <div className={css.fileWrapper}
             style={
                url.length > 0
                  ...
                  : props.countryDefault && containerStyle
              }>
