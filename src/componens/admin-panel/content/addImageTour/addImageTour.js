...
<div className="addImage-block-btn">
    <button className="addImage-back" onClick={()=>props.back1()}>&#10092; Back</button>
<button className="addImage-btn" onClick={Postdata}>Upload images</button>
</div>
      </div>
    </div>
  );
...
TourPictureAdd:(id,dataImage)=>dispatch(TourPictureAddAdmin(id,dataImage)),
